...
ICONS = {
    ...
    # Замок: друг это скрыл.
    "lock": stroke('<rect x="4.6" y="10.4" width="14.8" height="9.6" rx="2.2"/>'
                   '<path d="M8.2 10.4V7.8a3.8 3.8 0 0 1 7.6 0v2.6"/><path d="M12 14.2v2"/>'),
    # Копия: код для друзей уходит в буфер обмена.
    "copy": stroke('<rect x="8.4" y="8.4" width="11.2" height="11.2" rx="2"/>'
                   '<path d="M15.6 8.4V6.2a1.8 1.8 0 0 0-1.8-1.8H6.2a1.8 1.8 0 0 0-1.8 '
                   '1.8v7.6a1.8 1.8 0 0 0 1.8 1.8h2.2"/>'),
    # Камера: скриншот из оверлея.
    "camera": stroke('<path d="M3 8.4a1.8 1.8 0 0 1 1.8-1.8h2.4l1.4-2.2h6.8l1.4 2.2h2.4A1.8 '
                     '1.8 0 0 1 21 8.4v9.4a1.8 1.8 0 0 1-1.8 1.8H4.8A1.8 1.8 0 0 1 3 17.8V8.4Z"/>'
                     '<circle cx="12" cy="12.8" r="3.6"/>'),
    # Запись: последние 30 секунд игры.
    "rec": stroke('<rect x="2.6" y="6.4" width="13.4" height="11.2" rx="2.2"/>'
                  '<path d="m16 11.4 5.4-3.1v7.4L16 12.6"/>'),
    # Стена: плотная сетка обложек.
    "wall": stroke('<rect x="3.4" y="3.4" width="7.4" height="7.4" rx="1.4"/>'
    ...
    # Строки: таблица «Терминала». Метки слева толще — это столбец статуса.
    "rows": stroke('<path d="M3.6 6h16.8M3.6 12h16.8M3.6 18h16.8"/>'
                   '<path d="M3.6 6h3M3.6 12h3M3.6 18h3" stroke-width="2.6"/>'),
    # Геймпад: режим «Пульт».
    "pad": stroke('<path d="M7.4 7.4h9.2a4.6 4.6 0 0 1 4.5 3.7l.7 4a3 3 0 0 1-5.4 2.3l-1.2-1.6H8.8'
                  'l-1.2 1.6a3 3 0 0 1-5.4-2.3l.7-4a4.6 4.6 0 0 1 4.5-3.7Z"/>'
                  '<path d="M6.6 11.4v2.4M5.4 12.6h2.4M16.4 12h.1M18.2 13.8h.1"/>'),
